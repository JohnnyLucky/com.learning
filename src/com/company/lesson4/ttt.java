    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                for (double i = expenses[day - 1]; i < expenses.length; i = expenses[day - 1] + expense) // Сохраните трату в массив
                // expenses[day - 1] = expenses[day - 1] + expense; // Сохраните трату в массив то же самое что и выше
